...
SCALE = {
    0: ('', '', '', False),
    1: ('илјада', 'илјади', 'илјади', True),  # 10^3
    2: ('милион', 'милиони', 'милиони', False),  # 10^6
    3: ('билион', 'билиони', 'билиони', False),  # 10^9
    4: ('трилион', 'трилиони', 'трилиони', False),  # 10^12
    5: ('квадрилион', 'квадрилиони', 'квадрилиони', False),  # 10^15
    6: ('квантилион', 'квантилиони', 'квантилиони', False),  # 10^18
    7: ('секстилион', 'секстилиони', 'секстилиони', False),  # 10^21
    8: ('септилион', 'септилиони', 'септилиони', False),  # 10^24
    9: ('октилион', 'октилиони', 'октилиони', False),  # 10^27
    10: ('нонилион', 'нонилиони', 'нонилиони', False),  # 10^30
}
...
class Num2Word_MK(Num2Word_Base):
    CURRENCY_FORMS = {
        'RUB': (
            ('рубљи', 'рубљи', 'рубљи', True),
            ('копејка', 'копејки', 'копејки', True)
        ),
        'EUR': (
            ('евро', 'евра', 'евра', False),
            ('цент', 'центи', 'центи', False)
        ),
        'MKD': (
            ('денар', 'денари', 'денари', False),
            ('пара', 'пари', 'пари', True)
        ),
    }
    ...
    def to_currency(self, val, currency='MKD', cents=True, separator=',',
                    adjective=False):
        """
        Args:
            val: Numeric value
